  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-indigo-900 p-6">
      <div className="flex items-center flex-shrink-0 text-orange-400 mr-6">
        <span className="font-semibold text-xl tracking-tight">Divine Dry Fruits And Foods</span>
      </div>
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <a href="#" className="inline-block text-sm px-4 py-2 leading-none rounded text-orange-400  mt-4 lg:mt-0">
            Login
          </a>
          <a href="#" className="inline-block text-sm px-4 py-2 leading-none rounded text-orange-400 mt-4 lg:mt-0">
            Registration
